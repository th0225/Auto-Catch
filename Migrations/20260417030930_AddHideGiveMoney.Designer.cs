...
namespace AutoCatch.Migrations
{
    ...
    [Migration("20260417030930_AddHideGiveMoney")]
    partial class AddHideGiveMoney
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AutoCatch.Models.PttSettings", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            BoardConfigs = "[{\"Name\":\"Lifeismoney\",\"NumPost\":10,\"MinNrec\":0,\"HideReplies\":true,\"HideGiveMoney\":true}]",
                            Enabled = true,
